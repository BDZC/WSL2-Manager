...
!define PRODUCT_PUBLISHER "Michael Drawdy"
!define PRODUCT_WEB_SITE "https://github.com/wslhub/WSL-DistroManager/"
...
Section "MainSection" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite try
  File /r /x Publish.cmd /x WslManager.zip "bin\Release\*"
